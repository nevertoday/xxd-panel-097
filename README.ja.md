...
作例枠は確保済みです。検証可能な原作リンク、または 097 原文プロンプトに直接照合した追加作例が揃い次第ここで優先表示し、別番号の画像や壊れたプレースホルダーで代用しません。
...
**Panel 097** は正確な輪郭で同一性を残し、深い黒の輪郭、図式的な幾何、写真から抽出した一色、手描き文字、印刷粒子で構成します。
...
| **識別しやすい特徴** | 機能的な輪郭、模式的な遠近、黒と抽出した特色、手描き文字、温かな紙面 |
