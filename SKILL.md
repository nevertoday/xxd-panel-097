...
```text
/xxd-panel-097 <source-or-directory> --mode top-bottom,design-only \
...
1. 上下对照（原图在上，097 设计在下）
2. 左右对照（原图在左，097 设计在右）
...
```text
~/Desktop/xxd/xxd-panel-097/<fresh-task>/
...
- `references/xxd-panel-097-prompt.zh-CN.md`
- `references/xxd-panel-097-prompt.en.md`
