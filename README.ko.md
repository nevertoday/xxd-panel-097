...
예시 영역은 예약되어 있습니다. 검증 가능한 원작 링크나 097 원본 프롬프트와 직접 대조한 확장 예시가 준비되면 이곳에 먼저 표시하며, 다른 번호의 이미지나 깨진 자리표시자로 대신하지 않습니다.
...
**Panel 097**은 정확한 윤곽으로 정체성을 남기고 짙은 검정 윤곽, 도식적 기하, 사진에서 추출한 한 가지 별색, 손글씨와 인쇄 입자로 명암·부피·재질을 엮습니다. 식별 부위만 세밀하게 하고 나머지는 의도적으로 미완성에 둡니다.
...
| **대표 특징** | 파란 윤곽, 도식 윤곽, 기하 구조, 사진에서 추출한 별색, 선택적 세부, 넓은 자연 종이 |
