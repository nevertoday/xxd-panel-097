<p align="center"><img src="./assets/banner.svg" alt="لافتة مشروع XXD Panel 097" width="1200"></p>

<div align="center">

# 🦁 XXD Panel 097｜بطاقة تعليمات رجعية

### يضغط الصورة إلى مخطط تجاري شعبي بلونين، واضح وذكي وعملي
...
تبقى `sample-01`–`sample-04` محجوزة لنماذج الإصدار الأصلية القابلة للتحقق. تضم الأعمال الثمانية أعلاه أربعة نماذج أفقية 16:9 بتكوين يسار–يمين وأربعة نماذج رأسية 3:4 بتكوين أعلى–أسفل. ولّد Panel 097 كل عمل بصورة مستقلة وفق موجّهه الأصلي، من دون إعادة استخدام أعمال أي Panel آخر. تستخدم النماذج نصاً إنجليزياً مولّداً بذكاء.

<!-- xxd-human-intro:start -->
## ما الذي يحله هذا الأسلوب؟

لا تحتاج المعلومات المعقدة في الصورة إلى رسم كامل. يضغطها Panel 097 في رسم وظيفي يشبه دليلاً قديماً أو بطاقة إعلان أو نشرة داخل عبوة.

يحفظ **Panel 097** هوية الموضوع باقتصاد الخط والمنظور التخطيطي المسطّح وعدد قليل من الأشكال الهندسية. يحمل الأسود العميق المحيط وطبقة المعلومات، ويُستخرج اللون الموضعي الثاني من الصورة لتكوين طباعة من لونين منضبطة. وتحول الحروف التجارية المرسومة يدوياً وخطوط الإشارة والفكاهة الوظيفية الخفيفة فعل «الشرح» نفسه إلى صورة.

### مناسب لـ

- **رسم توضيحي يُفهم من النظرة الأولى:** شرح الموضوع والقصة بالمحيط والصناديق والفتحات واللوحات واتجاه الحركة؛
- **قوة الطباعة القديمة:** أسود عميق مع لون ثانٍ مشتق من الصورة فوق ورق دافئ وحبيبات انحراف طباعي خفيفة؛
- **فكاهة بسيطة بلا تكلّف:** استخدام الحروف التجارية اليدوية والرموز المساعدة لخدمة السرد فقط؛
- **التسليم المرن:** أعلى–أسفل ويسار–يمين وتصميم فقط ونسب متعددة وخلفيات لأربع أجهزة ومعالجة المجلدات.

### بداية سريعة

> استخدم XXD Panel 097 لمعالجة هذه الصورة واقترح أولاً أنسب تكوين وحجم.
...
**البصمة:** رسوم تجارية شعبية من منتصف القرن · رسم خطي تخطيطي · اقتصاد الخط · طباعة بلونين · حروف يدوية · طرافة وظيفية
...
|---|---|
| **الناتج** | رسم وظيفي بلونين واضح ومنضبط وخفيف الفكاهة كأنه بطاقة تعليمات قديمة |
| **البصمة الواضحة** | محيط وظيفي، منظور تخطيطي، أسود عميق ولون من الصورة، حروف تجارية يدوية، وفكاهة خفيفة |
| **احترام المصدر** | يحفظ الهوية ومنطق المشهد، ويحذف الخلفية المعقدة، ثم يعيد تنظيم الموضع والكثافة والإيقاع |
| **الاستخدامات** | ملصقات وأغلفة ومحتوى اجتماعي وتصميم مستقل ونسب متعددة وخلفيات لأربع أجهزة |
<!-- xxd-panel-benefit:end -->

## منطق التحويل

```text
تحليل الموضوع والمحيط والبنية والوضع والعلاقة السردية → ضغطها إلى هندسة وخطوط وظيفية قليلة → بناء طباعة بلونين من الأسود واللون الثاني المستخرج → إضافة المعلومات والفكاهة بحروف تجارية يدوية وخطوط إشارة
```

## سمات النتيجة النهائية

- استخدم الأسود العميق وبياض الورق الدافئ ولوناً موضعياً ثانياً مستخرجاً من الصورة، واجعل الرسم التخطيطي بلونين هو الأساس.
- اتبع economy of line ولا تثبّت اللون الثاني آلياً على الأحمر.
- احتفظ فقط بالطاولة أو الأرض أو الحد أو الفتحة أو اللوحة أو اتجاه الحركة اللازم لشرح الموضوع.
- اجعل الحروف التجارية اليدوية وخطوط الإشارة قليلة ومفيدة ومندمجة في الرسم لا زخرفة منفصلة.
- تجنّب الواقعية والخطوط الكرتونية الغليظة والمتجهات المصقولة والكرتون وكثرة التفاصيل ومرشحات الحاسوب والقوالب الجاهزة.

توجد القيود الجمالية فقط في [الموجّه الأصلي](references/original-prompt/zh-CN.md). يعالج الـ Skill ومهايئات التشغيل متغيرات التسليم فقط. [Skill](SKILL.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-097-prompt.en.md)
...
عند تمرير مجلد صور مباشرةً، تعالجه مهارة الجندي دفعةً واحدة بالجمالية الأصلية نفسها لـ Panel 097. تفحص المهارة صيغ الصور النقطية الشائعة تكرارياً، وتعلن العدد، ثم تحسم النمط والحجم والنص واللغة مرة واحدة. تُولَّد كل صورة باستقلال من دون تسرب المحتوى أو النص بين العناصر، وتبقى الدفعة كلها داخل مجلد مهمة مسطح واحد. يُسجَّل فشل أي عنصر من دون إسقاط الصور اللاحقة بصمت.
...
/xxd-panel-097 photo.jpg --mode top-bottom --size auto --text prompt --locale ar-SA
...
/xxd-panel-097 photo.jpg --mode design-only --size 9:16 --text prompt --locale ar-SA
...
/xxd-panel-097 photo.jpg --mode design-only --size 3:4 --text prompt --locale ar-SA

# استخدام النص الحرفي بلا إعادة صياغة أو ترجمة أو عنوان إضافي
/xxd-panel-097 photo.jpg --mode design-only --size 3:4 --copy "دع الضوء يبقى هنا" --locale ar-SA

# نمطان × ثلاثة أحجام ينتجان ستة تكوينات كاملة مستقلة
/xxd-panel-097 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale ar-SA

# تطبيق Panel 097 على مجلد كامل مع حسم الإعدادات المشتركة مرة واحدة
/xxd-panel-097 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale ar-SA
...
يمكن لمستخدمي Claude Code ربط المجلد نفسه بالمسار: `~/.claude/skills/xxd-panel-097`. أعد تشغيل جلسة الوكيل بعد التثبيت.
...
المواصفات الكاملة: [مسار عمل المهارة](SKILL.md) · [أرشيف الأسلوب الأصلي](references/original-prompt/zh-CN.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-097-prompt.en.md) · [مهايئ التشغيل الصيني](references/xxd-panel-097-prompt.zh-CN.md)
...
| **الجنود** | `xxd-panel-NNN` (حالياً 001–097) | تنفذ كل مهارة مرقمة موجّهها الأصلي وجماليتها الخاصة فقط، وتنجز المهمة الفردية التي يرسلها الجنرال. |
